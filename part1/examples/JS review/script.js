...
//更多内容请参考MDN的JavaScript教程: https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Guide
//总结
//1. 使用const和let来声明变量，优先使用const
//2. 多使用数组的不可变方法，如map, filter, reduce等，避免使用push等会改变原数组的方法
//3. 使用箭头函数来定义函数，语法更简洁
//4. 多学习和使用解构赋值，简化代码
//5. 多参考MDN的JavaScript教程，深入学习JavaScript的各种特性和用法
